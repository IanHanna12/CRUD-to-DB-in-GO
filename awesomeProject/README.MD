...
### Implementation
- The `AuthMiddleware` function is used as a wrapper for protected routes in routing.
...
TODO: Test admin view, prefetch by userID to get all blogs of a user but 
                       restrict to only the user's own blogs